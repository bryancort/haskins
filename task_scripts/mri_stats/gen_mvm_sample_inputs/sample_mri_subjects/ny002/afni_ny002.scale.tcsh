...
# execute via : 
#   tcsh -xef afni_ny002.scale.tcsh 2>&1 | tee output.afni_ny002.scale.tcsh
...
cp ny002.results/dfile_rall.1D $output_dir

# copy extra files into results dir
cp -rv ny002.results/anat_final.ny002+tlrc.BRIK \
    ny002.results/anat_final.ny002+tlrc.HEAD $output_dir

# ============================ auto block: tcat ============================
# apply 3dTcat to copy input dsets to results dir, while
# removing the first 0 TRs
3dTcat -prefix $output_dir/pb00.$subj.r01.tcat \
    ny002.results/pb03.ny002.r01.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r02.tcat \
    ny002.results/pb03.ny002.r02.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r03.tcat \
    ny002.results/pb03.ny002.r03.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r04.tcat \
    ny002.results/pb03.ny002.r04.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r05.tcat \
    ny002.results/pb03.ny002.r05.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r06.tcat \
    ny002.results/pb03.ny002.r06.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r07.tcat \
    ny002.results/pb03.ny002.r07.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r08.tcat \
    ny002.results/pb03.ny002.r08.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r09.tcat \
    ny002.results/pb03.ny002.r09.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r10.tcat \
    ny002.results/pb03.ny002.r10.blur+tlrc'[0..$]'
...
#
# afni_proc.py -subj_id ny002 -script afni_ny002.scale.tcsh -out_dir          \
#     ny002.scale -dsets ny002.results/pb03.ny002.r01.blur+tlrc.HEAD          \
#     ny002.results/pb03.ny002.r02.blur+tlrc.HEAD                             \
#     ny002.results/pb03.ny002.r03.blur+tlrc.HEAD                             \
#     ny002.results/pb03.ny002.r04.blur+tlrc.HEAD                             \
#     ny002.results/pb03.ny002.r05.blur+tlrc.HEAD                             \
#     ny002.results/pb03.ny002.r06.blur+tlrc.HEAD                             \
#     ny002.results/pb03.ny002.r07.blur+tlrc.HEAD                             \
#     ny002.results/pb03.ny002.r08.blur+tlrc.HEAD                             \
#     ny002.results/pb03.ny002.r09.blur+tlrc.HEAD                             \
#     ny002.results/pb03.ny002.r10.blur+tlrc.HEAD -blocks mask scale regress  \
#     -copy_files ny002.results/anat_final.ny002+tlrc.BRIK                    \
#     ny002.results/anat_final.ny002+tlrc.HEAD -regress_stim_times            \
...
#     -regress_motion_file ny002.results/dfile_rall.1D -regress_reml_exec     \
