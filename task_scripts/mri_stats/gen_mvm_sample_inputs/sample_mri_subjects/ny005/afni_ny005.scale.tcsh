...
# execute via : 
#   tcsh -xef afni_ny005.scale.tcsh 2>&1 | tee output.afni_ny005.scale.tcsh
...
cp ny005.results/dfile_rall.1D $output_dir

# copy extra files into results dir
cp -rv ny005.results/anat_final.ny005+tlrc.BRIK \
    ny005.results/anat_final.ny005+tlrc.HEAD $output_dir

# ============================ auto block: tcat ============================
# apply 3dTcat to copy input dsets to results dir, while
# removing the first 0 TRs
3dTcat -prefix $output_dir/pb00.$subj.r01.tcat \
    ny005.results/pb03.ny005.r01.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r02.tcat \
    ny005.results/pb03.ny005.r02.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r03.tcat \
    ny005.results/pb03.ny005.r03.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r04.tcat \
    ny005.results/pb03.ny005.r04.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r05.tcat \
    ny005.results/pb03.ny005.r05.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r06.tcat \
    ny005.results/pb03.ny005.r06.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r07.tcat \
    ny005.results/pb03.ny005.r07.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r08.tcat \
    ny005.results/pb03.ny005.r08.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r09.tcat \
    ny005.results/pb03.ny005.r09.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r10.tcat \
    ny005.results/pb03.ny005.r10.blur+tlrc'[0..$]'
...
#
# afni_proc.py -subj_id ny005 -script afni_ny005.scale.tcsh -out_dir          \
#     ny005.scale -dsets ny005.results/pb03.ny005.r01.blur+tlrc.HEAD          \
#     ny005.results/pb03.ny005.r02.blur+tlrc.HEAD                             \
#     ny005.results/pb03.ny005.r03.blur+tlrc.HEAD                             \
#     ny005.results/pb03.ny005.r04.blur+tlrc.HEAD                             \
#     ny005.results/pb03.ny005.r05.blur+tlrc.HEAD                             \
#     ny005.results/pb03.ny005.r06.blur+tlrc.HEAD                             \
#     ny005.results/pb03.ny005.r07.blur+tlrc.HEAD                             \
#     ny005.results/pb03.ny005.r08.blur+tlrc.HEAD                             \
#     ny005.results/pb03.ny005.r09.blur+tlrc.HEAD                             \
#     ny005.results/pb03.ny005.r10.blur+tlrc.HEAD -blocks mask scale regress  \
#     -copy_files ny005.results/anat_final.ny005+tlrc.BRIK                    \
#     ny005.results/anat_final.ny005+tlrc.HEAD -regress_stim_times            \
...
#     -regress_motion_file ny005.results/dfile_rall.1D -regress_reml_exec     \
