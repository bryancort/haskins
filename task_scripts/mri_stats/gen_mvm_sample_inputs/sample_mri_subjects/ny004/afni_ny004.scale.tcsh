...
# execute via : 
#   tcsh -xef afni_ny004.scale.tcsh 2>&1 | tee output.afni_ny004.scale.tcsh
...
cp ny004.results/dfile_rall.1D $output_dir

# copy extra files into results dir
cp -rv ny004.results/anat_final.ny004+tlrc.BRIK \
    ny004.results/anat_final.ny004+tlrc.HEAD $output_dir

# ============================ auto block: tcat ============================
# apply 3dTcat to copy input dsets to results dir, while
# removing the first 0 TRs
3dTcat -prefix $output_dir/pb00.$subj.r01.tcat \
    ny004.results/pb03.ny004.r01.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r02.tcat \
    ny004.results/pb03.ny004.r02.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r03.tcat \
    ny004.results/pb03.ny004.r03.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r04.tcat \
    ny004.results/pb03.ny004.r04.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r05.tcat \
    ny004.results/pb03.ny004.r05.blur+tlrc'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r06.tcat \
    ny004.results/pb03.ny004.r06.blur+tlrc'[0..$]'
...
#
# afni_proc.py -subj_id ny004 -script afni_ny004.scale.tcsh -out_dir          \
#     ny004.scale -dsets ny004.results/pb03.ny004.r01.blur+tlrc.HEAD          \
#     ny004.results/pb03.ny004.r02.blur+tlrc.HEAD                             \
#     ny004.results/pb03.ny004.r03.blur+tlrc.HEAD                             \
#     ny004.results/pb03.ny004.r04.blur+tlrc.HEAD                             \
#     ny004.results/pb03.ny004.r05.blur+tlrc.HEAD                             \
#     ny004.results/pb03.ny004.r06.blur+tlrc.HEAD -blocks mask scale regress  \
#     -copy_files ny004.results/anat_final.ny004+tlrc.BRIK                    \
#     ny004.results/anat_final.ny004+tlrc.HEAD -regress_stim_times            \
...
#     -regress_motion_file ny004.results/dfile_rall.1D -regress_reml_exec     \
