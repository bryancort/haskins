...
def genArgParser():
    ...
    mvm_output_prefix_default = "output_mvm_{}.txt".format(base_utils.getLocalTime())
    ...
    parser.add_argument("--output_call_name", default=output_call_name_default,
                        help="Name (no preceding path) of the call output file. It will be created in output_dir. "
    ...
    parser.add_argument("--mask_path", default=mask_path_default,
                        help="Path to the mask to use in the MVM. This does not need to exist when this script is run, "
                             "but must exist at 3dMVM's runtime; eg., if you leave this option as the default, "
                             "{d}, {d} must be a valid path (either relative from the location of your MVM call, or "
                             "absolute) when you execute the script generated by this tool. "
